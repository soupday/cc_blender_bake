...
updater.addon = "cc3_blender_bake_updater"
...
def register(bl_info):
	...
	updater.user = "soupday"

	# choose your own repository, must match git name for GitHUb and Bitbucket,
	# for GitLab use project ID (numbers only)
	updater.repo = "cc3_blender_bake"

	#updater.addon = # define at top of module, MUST be done first

	# Website for manual addon download, optional but recommended to set
	updater.website = "https://github.com/soupday/cc3_blender_bake"
	...
	updater.backup_ignore_patterns = ["__pycache__", ".vscode"]
	...
	updater.overwrite_patterns = ["*.blend","*.png","*.jpg","README.md","LICENSE"]
